...
template <class T1, class T2> std::ostream& operator<<(std::ostream& os, const std::pair<T1, T2> & p){ return os << p.first << "," << p.second; }
...
template <class T> std::ostream& operator<<(std::ostream& os, const std::set<T> & st){ os<<"{ "; for(const auto& ele : st){ os << ele<<" ";}; os << "}"; return os; }
template <class T> std::ostream& operator<<(std::ostream& os, const std::unordered_set<T> & st){ os<<"{ "; for(const auto& ele : st){ os << ele<<" ";}; os << "}"; return os; }
